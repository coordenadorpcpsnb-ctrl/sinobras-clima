...
leakage-safe das Fases 1.x (backtest.py::cortar_serie), aplicado aqui à
série CHIRPS por município em vez da série regional Sinobras.
...
import benchmark_modelos as bm  # noqa: E402 — reaproveita MES_PARA_ESTACAO/classificar_periodo_operacional

MES_PARA_ESTACAO = bm.MES_PARA_ESTACAO
classificar_periodo_operacional = bm.classificar_periodo_operacional
